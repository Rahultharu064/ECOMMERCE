        ...
        <section class="filter-section">
            <form method="GET" action="products.php" class="filter-form">
                <div class="filter-group">
                    ...
                    <input type="text" id="search" name="search" placeholder="Medication name, description..." value="<?php echo htmlspecialchars($search); ?>">
                </div>
        ...
        <section class="products-container">
            ...
            <?php if ($total_pages > 1): ?>
                <div class="pagination">
                    <?php if ($page > 1): ?>
                        <a href="products.php?page=<?php echo $page - 1; ?>&search=<?php echo urlencode($search); ?>&category_id=<?php echo $category_id; ?>">
                    ...
                    if ($start_page > 1) {
                        echo '<a href="products.php?page=1&search='.urlencode($search).'&category_id='.$category_id.'">1</a>';
                        if ($start_page > 2) echo '<span>...</span>';
                    }
                    
                    for ($i = $start_page; $i <= $end_page; $i++): ?>
                        <a href="products.php?page=<?php echo $i; ?>&search=<?php echo urlencode($search); ?>&category_id=<?php echo $category_id; ?>"
                    ...
                    if ($end_page < $total_pages) {
                        ...
                        echo '<a href="products.php?page='.$total_pages.'&search='.urlencode($search).'&category_id='.$category_id.'">'.$total_pages.'</a>';
                    }
                    ?>
