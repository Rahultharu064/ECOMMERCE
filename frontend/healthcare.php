...
// Set category for Healthcare
$category_id = 10; // Change to your actual category ID for Healthcare
...
<body>
    ...
    <main class="main-container">
        ...
        <section class="filter-section">
            <form method="GET" action="healthcare.php" class="filter-form">
        ...
        <section class="products-container">
            ...
            <?php if ($total_pages > 1): ?>
                <div class="pagination">
                    <?php if ($page > 1): ?>
                        <a href="healthcare.php?page=<?php echo $page - 1; ?>&search=<?php echo urlencode($search); ?>">
                    ...
                    if ($start_page > 1) {
                        echo '<a href="healthcare.php?page=1&search='.urlencode($search).'">1</a>';
                        if ($start_page > 2) echo '<span>...</span>';
                    }
                    
                    for ($i = $start_page; $i <= $end_page; $i++): ?>
                        <a href="healthcare.php?page=<?php echo $i; ?>&search=<?php echo urlencode($search); ?>"
                    ...
                    if ($end_page < $total_pages) {
                        ...
                        echo '<a href="healthcare.php?page='.$total_pages.'&search='.urlencode($search).'">'.$total_pages.'</a>';
                    }
                    ?>
