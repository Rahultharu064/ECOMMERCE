...
<body>
    ...
    <main class="main-container">
        ...
        <section class="filter-section">
            <form method="GET" action="healthpackages.php" class="filter-form">
        ...
        <section class="products-container">
            ...
            <?php if ($total_pages > 1): ?>
                <div class="pagination">
                    <?php if ($page > 1): ?>
                        <a href="healthpackages.php?page=<?php echo $page - 1; ?>&search=<?php echo urlencode($search); ?>">
                    ...
                    if ($start_page > 1) {
                        echo '<a href="healthpackages.php?page=1&search='.urlencode($search).'">1</a>';
                        if ($start_page > 2) echo '<span>...</span>';
                    }
                    
                    for ($i = $start_page; $i <= $end_page; $i++): ?>
                        <a href="healthpackages.php?page=<?php echo $i; ?>&search=<?php echo urlencode($search); ?>"
                    ...
                    if ($end_page < $total_pages) {
                        ...
                        echo '<a href="healthpackages.php?page='.$total_pages.'&search='.urlencode($search).'">'.$total_pages.'</a>';
                    }
                    ?>
